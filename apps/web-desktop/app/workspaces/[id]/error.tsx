  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-nomados-background">
      <div className="text-center">
        ...
        <h2 className="text-lg font-semibold text-nomados-text mb-2">Workspace Error</h2>
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <Link
            href="/workspaces"
            className="rounded-lg border border-nomados-border px-4 py-2 text-sm font-medium text-nomados-text transition-colors hover:bg-nomados-border/30"
          >
            Back to Workspaces
          </Link>
        </div>
