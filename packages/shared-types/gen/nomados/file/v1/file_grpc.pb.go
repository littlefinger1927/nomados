...
const (
	FileService_Upload_FullMethodName   = "/nomados.file.v1.FileService/Upload"
	FileService_Download_FullMethodName = "/nomados.file.v1.FileService/Download"
	FileService_List_FullMethodName     = "/nomados.file.v1.FileService/List"
	FileService_Delete_FullMethodName   = "/nomados.file.v1.FileService/Delete"
)
...
type FileServiceClient interface {
	...
	Delete(ctx context.Context, in *DeleteFileRequest, opts ...grpc.CallOption) (*v1.Empty, error)
}
...
func (c *fileServiceClient) Delete(ctx context.Context, in *DeleteFileRequest, opts ...grpc.CallOption) (*v1.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.Empty)
...
type FileServiceServer interface {
	...
	Delete(context.Context, *DeleteFileRequest) (*v1.Empty, error)
...
func (UnimplementedFileServiceServer) Delete(context.Context, *DeleteFileRequest) (*v1.Empty, error) {
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "nomados.file.v1.FileService",
	...
	Metadata: "nomados/file/v1/file.proto",
}
